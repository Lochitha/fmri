...
{
$info = getData();
$search_query="SELECT * FROM broadman_area WHERE br_area_id = '$info[0]'";
...
{
$br_area_id = $rows['br_area_id'];
$area_nme = $rows['area_nme'];
$gyral_land = $rows['gyral_land'];
//echo "$br_area_id";
                                ...
                                <div class="card-content table-responsive">
                                    <table class="table">
                                       <form>
                                              ...
                                              <input  style="size: 20px" type="text" name="br_area_id" value="<?php echo "$br_area_id"?>">
                                              <br><br>
                                              <b>The Functional Area relevant to the Brodmann area:</b><br>
                                              <input style="size: 40px" type="text" name="area_nme" value="<?php echo "$area_nme"?>">
                                              <br><br>
                                              <b>The Gyral landmarks relevant to the Brodmann area:</b><br>
                                              <input style="size: 20px" type="text" name="gyral_land" value="<?php echo $gyral_land ?>">
                                              <br><br>
